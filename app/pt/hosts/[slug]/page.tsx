...
export async function generateMetadata({
  ...
  return {
    title: cleanMetadataTitle(host?.headline_pt || host?.name) || "Perfil de anfitrião",
    description: host?.intro_pt || "Perfil público de anfitrião local na Home in the City.",
    ...
    twitter: { card: "summary_large_image", title: host?.headline_pt || host?.name || "Perfil de anfitrião", description: host?.intro_pt || "Perfil público de anfitrião local na Home in the City.", images: host?.photo?.asset?.url ? [host.photo.asset.url] : undefined },
  };
}
