...
export default function CityPage({ lang }: { lang: Lang }) {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#1a1f2e] px-6 pt-28 pb-16 md:bg-stone-50">
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 h-[900px] bg-[url('/porto-alegre-desktop-background.jpg')] hidden md:block bg-cover bg-center opacity-80" />
      <div className="pointer-events-none absolute inset-x-0 top-0 h-[900px] bg-gradient-to-b from-[#1a1f2e]/10 via-white/10 to-stone-50/40" />
