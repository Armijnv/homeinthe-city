...
export async function generateMetadata({
  ...
  return {
    title: `Vastgoed in ${city.title}`,
    description: `Koop- en huuraanbod in ${city.title} van Home in the City.`,
    alternates: {
      canonical: `${siteUrl}/nl/vastgoed/${citySlug}`,
      languages: {
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <RealEstateCityPage
      lang="nl"
      city={realEstateCityConfigFromListings("nl", citySlug, listings)}
      listings={listings}
    />
  );
}
