...
export const city = defineType({
  ...
  fields: [
    ...
    defineField({ name: "name_nl", title: "Name (Dutch)", type: "string" }),
    ...
    defineField({ name: "cta_pt", title: "CTA Text (Portuguese)", type: "string" }),
    defineField({ name: "cta_nl", title: "CTA Text (Dutch)", type: "string" }),
